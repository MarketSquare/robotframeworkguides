...
date: 2022-07-27
authors: [miikka]
tags: [open-source, automation, community, robot-framework]
slug: robot-framework-foundation
# medium_url: https://medium.com/@RobotFramework/robot-framework-foundation-a37a8bcec74f
---

In this post I am going to talk about the Robot Framework Foundation who we are and how we operate. I am making a dive into the Robot framework tool and its usage in the follow-up posts. If you have a user story you would like to tell, please do [reach out](mailto:robotframework-foundation@googlegroups.com)!

{/* truncate */}

![](/img/blog/1_rLyvpD_QfA5mbPqfX0qlvQ.png)
...
Naturally, some paid help is also used for example to maintain the webpage, bookkeeping and organizing the conference but we do rely heavily on the volunteers. If you want to contribute, do not hesitate to [contact](mailto:robotframework-foundation@googlegroups.com) us!
...
The Foundation is on the move. We are constantly developing new ways to bring more value to the members, the community and the users. To help us even better serve your needs, please do consider [joining the Foundation](https://robotframework.org/foundation). It is the easiest way to contribute.
