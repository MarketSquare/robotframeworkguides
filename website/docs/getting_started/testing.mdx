...
We recommend having a folder on your drive to store your projects, e.g. `C:\projects`.  
Open your `terminal`
...
We recommend having a folder on your drive to store your projects, e.g. `~/projects`.  
Open your `terminal`
...
Poetry will save the virtual environments in the `.poetry/envs` folder. You can change that setting and store your virtual environment in the project folder by running
