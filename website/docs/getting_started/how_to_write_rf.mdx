...
1. Settings
1. Test Cases
{/* If more content is added, the titles above should get deeplinks */}
...
## Everything together
<iframe src="https://robotframework.surge.sh/embed/?code-gh-url=https://github.com/MarketSquare/robotframeworkguides/tree/main/code-examples/my_first_test" width="100%" height="600"></iframe>
